...
public class UserController {
    ...
    @ApiOperation("Post a movie as favorite.")
    @ApiResponses(value = {
    ...
    public UserResponse markFavorite(@PathVariable Long userId, @RequestBody TmdbMovie tmdbMovie)
            throws TmdbIdExistsException, UserNotFoundException {
        User user = userService.addFavoriteMovie(userId, fromTmdb(tmdbMovie));
        return toDTO(user);
    }
